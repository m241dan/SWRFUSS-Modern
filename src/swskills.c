...
void do_makespice(CHAR_DATA* ch, const char* argument)
{
    ...
    switch (ch->substate)
    {
        default:mudstrlcpy(arg, argument, MAX_INPUT_LENGTH);
    ...
    obj->value[1] = URANGE(10, obj->value[1], (
...
void do_mine(CHAR_DATA* ch, const char* argument)
{
    ...
    switch (ch->in_room->sector_type)
    {
        ...
        case SECT_UNDERWATER:send_to_char("You cannot bury a mine in the water.\r\n", ch);
            return;
        case SECT_AIR:send_to_char("What?  Bury a mine in the air?!\r\n", ch);
            return;
    }
...
void do_first_aid(CHAR_DATA* ch, const char* argument)
{
    ...
    {
        act(AT_ACTION, "You tend to $N's wounds.", ch, nullptr, victim, TO_CHAR);
...
void do_propeganda(CHAR_DATA* ch, const char* argument)
{
    ...
    ch_printf(
        ch, "You speak to them about the benifits of the %s%s.\r\n", ch->pcdata->clan->name,
