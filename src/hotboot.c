...
SHIP_DATA* load_ship(FILE* fp)
{
    ...
    for (;;)
    {
        ...
        switch (UPPER(word[0]))
        {
            ...
            case 'A':KEY("Autorecharge", ship->autorecharge, (bool)fread_number(fp));
            ...
            case 'H':KEY("Hull", ship->hull, fread_number(fp));
            ...
            case 'J':KEY("JX", ship->jx, (float)fread_number(fp));
            ...
            case 'M':KEY("Missiles", ship->missiles, fread_number(fp));
                break;

            case 'R':KEY("Rockets", ship->rockets, fread_number(fp));
                break;
            ...
            case 'V':KEY("VX", ship->vx, (float)fread_number(fp));
...
CHAR_DATA* load_mobile(FILE* fp)
{
    ...
    for (;;)
    {
        ...
        switch (UPPER(word[0]))
        {
            ...
            case 'F':KEY("Flags", mob->act, fread_number(fp));
                break;

            case 'G':KEY("Gold", mob->gold, fread_number(fp));
                break;
            ...
            case 'P':KEY("Position", mob->position, fread_number(fp));
                break;

            case 'R':KEY("Room", inroom, fread_number(fp));
